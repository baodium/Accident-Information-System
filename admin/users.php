...
<script src="../js/baaa_core.js" type="text/javascript"></script>
 ...
 body { 
    ...
    <script>
function tick(){
document.forms['frm'].ticker.value="ticked";
}



function deleteIt(selected){
if(document.forms['frm'].ticker.value !="ticked"){
alert("please select an item");
return false;
}

document.forms['frm'].ticker.value="";
if(selected=="delete"){
ret=confirm("Are you sure you want to delete this item(s)");
}

if(ret==true){
document.forms['frm'].id.value=selected;

document.forms['frm'].submit();//document.getElementById['id'].value);
}else if(ret==false){
...
<li class="js-top-menu-sales"><a href="users.php" fsource="loggedin_Seller_ManageSales" style=" border-right:1px dotted  #fff; color:#FFFF99; width:150px"><center> Users  </center>                                     </li></a>                                
                              ...
                              <div class="db-sidebar-inner">
                                ...
                                <section class="db-content db-content-conversation-detail">
                                    ...
                                    <header class="db-header header-nobot cf">
                                        <h1 class="with-thumb"> Users</h1>
                                    </header>

<div class="db-tabs-wrapper">
<form name="frm" method="post" action="" >
<br/><br/><div style="float:right; padding-right:10px; width:300px"  >&nbsp;&nbsp;<a href="#" style="background:#FF6666; height:30px; color:#FFFFFF; padding:10px 20px 10px 20px; border-radius:3px" onClick="deleteIt('delete');" >Delete Selected</a>&nbsp;&nbsp;<a href="new_user.php" style="background: #000033; color:#FFFFFF; height:30px;  padding:10px 40px 10px 40px; border-radius:3px" >Add New</a></div><br/><br/>
<div style=" padding:10px; height:300px">
   <table cellspacing="0" cellpadding="2" width="100%" style=" border-radius:5px" align="center"  >
                    <tr style="background:#003366; height:30px;  color:#FFFFFF; margin-bottom:20px;" >
                        <th style="width:30px; padding-bottom:10px; "><center>select</center></th>
                   		<th style="width:100px; padding-bottom:10px; "><center>Surname</center></th>
                        <th style="width:100px; padding-bottom:10px; "><center>Othernames</center></th>
                        <th style="width:100px; padding-bottom:10px; "><center>Username</center></th>
                     <th style="width:100px; padding-bottom:10px; "><center>Password</center></th>
                        </tr>
    <?php $i=0; foreach($users as $user){ $i++; ?>
   <tr class="<?php echo ($i%2==0?'odd':'')?>" style="height:30px; font-size:16px" ><td><center><input type="checkbox" name="select[]" onClick="tick();" value="<?php echo $user['id'] ?>" ></center></td>
                   		<td><center><?php echo $user['surname'] ?></center></td>
                        <td><center><?php echo $user['othernames'] ?></center></td>
