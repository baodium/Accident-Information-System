...
<center><div id="info" style="width:620px; font-size:20px; "><br/><br/><br/><br/>
                    ...
                    <tr ><td style="width:200px"><p style="margin-bottom:15px">Bends:</p></td><td><p><?php echo $route['bends'] ?></p></td></tr>
                     ...
                     <tr ><td style="width:200px"><p style="margin-bottom:15px">Status:</p></td><td><p><?php echo ($route['fatality_rate']<31)?'<img src="../images/green.png" id="status"  />&nbsp;Save':(($route['fatality_rate']>=31 && $route['fatality_rate']<61)?'<img src="../images/yellow.png"  />&nbsp;Fair':'<img src="../images/red.png"  />&nbsp;Poor'); ?></p></tr>
                   <tr ><td style="width:200px"><p style="margin-bottom:15px">Message:</p></td><td><p><?php echo ($route['fatality_rate']<31)?'This route is save to ply':(($route['fatality_rate']>=31 && $route['fatality_rate']<61)?'This route is fairly save to ply ':'This route is dangerous to ply'); ?></p></tr>
                    </table>
