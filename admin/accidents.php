<?php 
 var_dump(exec("java -jar weka.jar"));
session_start();
...
function doSubmit(){
var from=document.forms['downld'].from.value;
var to =document.forms['downld'].to.value;
if(from==""){
...
<li class="js-top-menu-sales"><a href="accidents.php" fsource="loggedin_Seller_ManageSales" style=" border-left:1px dotted  #fff; border-right:1px dotted  #fff; color:#FFFF99; width:150px"><center> Accidents  </center> 
...
<br/>
        ...
        <div class="msg-body">
       <form name="downld" action="routes/export.php"  method="post">
     <p><b>Accident From:</b>&nbsp;<input type="text" class="datepicker" placeholder="MM/DD/YYYY"  name="from"  style="width:130px"  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Accident To:</b>&nbsp;<input type="text" class="datepicker" placeholder="MM/DD/YYYY"  name="to"  style="width:130px"  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="btn-standard"  style=" background: #006600; color:#FFFFFF" type="button" name="" style="float:right;" value="Download Accidents (csv)" onClick="doSubmit();" title="Download Accidents" ></p>
     <input type="hidden" name="download" value="yes">
     </form><br/>
     <form name="downld_time" action="routes/export.php"  method="post">
     <p><b>Time from:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="time"  min="00:00" max="23:59"   value="00:00"   name="time_from"  style="width:130px"  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Time To:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="time"  min="00:00" max="23:59"   value="01:00"   name="time_to"  style="width:130px"  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="btn-standard"  style=" background: #006600; color:#FFFFFF" type="submit" name="download_time" style="float:right; " value="Download Accidents (csv)"  title="Download Accidents" ></p>
...
<article class="conv-message mine" id="message_34686812">
             ...
             <div class="msg-body">
          <h4 style="font-size:18px">Routes Name:&nbsp;<span style="color:#000033"><?php echo $accidents[0]['route_name']  ?></span></h4><br/>
             <div class="msg-body">
         <p>
