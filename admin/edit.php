...
$handle=new mainClass();
$routes=$handle->loadRoutes();
if(!($route=$handle->loadRoute($id))){
//header('location:index.php');
}
$param=$route[0];
//var_dump($rates);
...
<li class="js-top-menu-sales"><a href="users.php" fsource="loggedin_Seller_ManageSales" style=" border-left:1px dotted  #fff; border-right:1px dotted  #fff; color:#FFF; width:150px"><center> Users  </center>                                     </li></a>                                
 
<li><a href="" style="color: #A4C1D9; margin-left:200px">     <center> Hi: <?php //echo $_SESSION['xchangeuser'][0]['username'] ?>                             </center> </a>                            </li>
...
<div class="span7" style="margin-left:110px" >
			...
			<div class="visible-desktop" id="icon">
				<img src="../img/icon.png" style="width:60px; height:60px" />
			</div>
 <div id="app-name">
	<h1 style="font-size:36px; " >Osun State Accident Information System</h1><br/>
                <h2 style="font-size:16px">(Admin Home)</h2><br/>
    <div style=""><a href="index.php"><img  onClick="history.back()" src="../images/arrow-top.png">Back</a></div>
    <br/>
 </div>
            </div>
            <br/><br/>
                              ...
                              <div class="db-sidebar-inner">
                                ...
                                <section class="db-content db-content-conversation-detail">
                                    ...
                                    <header class="db-header header-nobot cf">
                                        <h1 class="with-thumb"> Edit Route </h1>
                                    </header>
...
<form name="childinfo"  method="post"><br/><br/>
 ...
 <p>Route name:&nbsp;</p><input type="text" name="route_name" style="width:300px" value="<?php echo(isset($param['route_name'])?$param['route_name']:'');  ?>"><br/><br/><br/>
            ...
            <p>Failed Segment:&nbsp;</p><input type="text" class="datepicker" name="failed_segment"  style="width:300px" value="<?php echo(isset($param['failed_segment'])?$param['failed_segment']:'');  ?>"/><br/><br/><br/>
           ...
           <p><input type="submit"  value="Save" name="update_route"  class="btn-standard" style=" width:150px; margin-left:150px; background: #000033; color:#FFFFFF; padding:10px 20px 10px 20px; "  /></p><br/>
            </div>
