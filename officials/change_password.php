...
<li class="js-top-menu-sales"><a href="change_password.php" fsource="loggedin_Seller_ManageSales" style="  border-right:1px dotted  #fff; color:#FFFF99; width:150px"><center> Change Password </center>                                     </li></a>                                
                              ...
                              <div class="db-sidebar-inner">
                                ...
                                <section class="db-content db-content-conversation-detail">
                                    ...
                                    <header class="db-header header-nobot cf">
                                        <h1 class="with-thumb">Change Password</h1>
                                    </header>
...
<center><?php  echo $error ?></center><br/>
            ...
            <p>Username:&nbsp;</p><input type="text" name="username" style="width:400px; background:#EAEAEA" value="<?php echo $_SESSION['official'][0]['username']  ?>" disabled ><br/><br/><br/>
            <p>Old Password:&nbsp;</p><input type="password" name="oldpassword" style="width:400px" value="">
            <br/><br/><br/>
            <p>New Password:&nbsp;</p><input type="password" name="newpassword" style="width:400px" value="">
            <br/><br/><br/>
            <p>Re-type New Password:&nbsp;</p><input type="password" name="newpassword2" style="width:400px" value="">
            
            <br/><br/><br/>
             <input type="submit" name="change_password" value="Submit" class="btn-standard" style=" width:150px; background: #000033; margin-left:250px; color:#FFFFFF; padding:10px; ">
            <br/><br/><br/>
 </div>        
 </form>
</div>  
